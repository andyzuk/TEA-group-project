...
recodedvars <- select(pi, c("basmid", "fssportx", "fsvol", "fsmtng", "fsptmtng", "fsatcnfn", "fsfundrs",
...
#FS is participation at school, FA is participation at home and SSAtis is satisfaction with school
...
#table(parental_involvement$AGE2015, parental_involvement$FS)
#ggplot(data=parental_involvement)+
  (mapping = aes(AGE2015, FS, color=FA))+geom_point()
...
#ggplot(data=parental_involvement)+geom_point(mapping= aes(x="FA", y="AGE2015"), size=3)
